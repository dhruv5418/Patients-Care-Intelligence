            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Schedular</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="admin.html">Home</a></li>
                                <li class="breadcrumb-item active">Manage Schedular</li>
                                <li class="breadcrumb-item active">Edit Schedular</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                 <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Schedular</h4>
                                <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                                <f:form class="form-material form-horizontal" novalidate="" modelAttribute="data" action="updateschedular.html" method="POST">
                                 
                                     <f:hidden path="schedularId"/>  
                                	                             
	                                     <div class="form-group">
	                                        <h5>Ward<span class="text-danger">*</span></h5>
	                                        <div class="controls">
	                                           
	                                           <f:select class="form-control" path="wardVO.wardId" >
	                                           	<c:forEach items="${wardList}" var="i" >
	                                           	<option value="${i.wardId}">${i.wardName} (${i.wardType} )</option> 
	                                           	</c:forEach>
	                                           </f:select> 
	                                            </div>
	                                             </div>
	                                    ...
	                                    <div class="form-group">
	                                        <h5>Nurse Name <span class="text-danger">*</span></h5>
	                                        <div class="controls">
	                                            <f:select class="form-control" path="nurseVO.nurseId"> 
	                                        <c:forEach items="${nurseList}" var="i">
	                                        <option value="${i.nurseId}">${i.firstName}</option>
	                                  ...
	                                  <div class="form-group">
	                                        ...
	                                        <div class="controls">
	                                            <f:input path="startDate" type="date" name="startDate"  class="form-control" required="required" data-validation-required-message="This field is required"/> </div>
	                                     ...
	                                     <div class="form-group">
	                                        ...
	                                        <div class="col-10">
	                                            <f:input path="startTime" class="form-control"  type="time" name="startTime" required="required" value="13:45:00" id="example-time-input"/>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <div class="controls">
	                                            <f:input path="endDate" type="date" name="endDate" class="form-control" required="required" data-validation-required-message="This field is required"/> </div>
	                                        <div class="form-control-feedback"></div>
	                                    </div>
	                                    <div class="form-group">
	                                        <h5>End Time <span class="text-danger">*</span></h5>
	                                        <div class="col-10">
	                                            <f:input path="endTime" class="form-control"  type="time"  name="endTime" required="required" value="13:45:00" id="example-time-input"/>
	                                        </div>
	                                    </div>
	                                     
	                                    <div class="form-group">
	                                        <h5>Current Date <span class="text-danger">*</span></h5>
	                                        <div class="controls">
	                                            <f:input path="currentDate" type="date" name="currentDate" class="form-control" required="required" data-validation-required-message="This field is required"/> </div>
	                                        <div class="form-control-feedback"></div>
	                                    </div> 
