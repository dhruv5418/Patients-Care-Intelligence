            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Reply Complaint</h4>
                    </div>
                ...
                <div class="row">
                 <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Reply Complaint</h4>
                                <f:form class="form-material form-horizontal" modelAttribute="data" action="sendreply.html">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <f:input type="text" path="subject" name="text" class="form-control" required="" data-validation-required-message="This field is required"/> </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <f:input type="text" path="message" name="text" class="form-control" required="" data-validation-required-message="This field is required"/> </div>
                                        <div class="form-control-feedback"></div>
                                    </div>
                                
                                      <div class="form-group row">
                                        <label for="example-date-input" class="col-2 col-form-label"></label>
                                            <f:hidden class="form-control" path="date" value="" required="required" id="example-date-input"/>
                                        </div>
                                        <div class="form-group row">
                                        <label for="example-date-input" class="col-2 col-form-label"></label>
                                            <f:hidden class="form-control" path="time"  value="" required="required=" id="example-date-input"/>
                                        </div>
                                        <f:hidden path="lvo.loginId"/>
                                        <div class="form-group">
                                        <h5> <span class="text-danger"></span></h5>
                                        <div class="controls">
                                            <f:hidden  path="status" name="text" class="form-control" required="required" data-validation-required-message="This field is required"/> </div>
                                        <div class="form-control-feedback"></div>
                                    </div>
                                     <div class="form-group">
                                        <label>Reply</label>
                                        <f:textarea class="form-control" path="reply" required="" rows="5"/>
                                    </div>
