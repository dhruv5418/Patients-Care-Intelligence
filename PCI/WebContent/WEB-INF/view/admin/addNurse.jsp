                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <f:form class="form-material form-horizontal" modelAttribute="data" action="insertNurse.html">
                                    
                                    
                                    <div class="form-group">
                                        <h5>First Name <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <f:input type="text" path="firstName" name="text" required="required" class="form-control" data-validation-required-message="This field is required"/> </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <f:input type="text" path="lastName" name="text" required="required" class="form-control" data-validation-required-message="This field is required"/> </div>
                                        <div class="form-control-feedback"></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                        		<f:input type="num" path="mobileNumber" maxlength="10" pattern="[0-9]{10}" required="required" name="text" class="form-control" data-validation-required-message="This field is required"/> 
												<%-- <f:input type="num" pattern="[0-9]{10}" path="mobileNumber" maxlength="10" required="required"/>                                           --%>

                                          <%-- <f:input type="text" pattern="[7|8|9][0-9]{9}" path="mobileNumber" name="text" class="form-control" required="required"/> --%></div>
                                   ...
                                   <div class="form-group">
                                           <h5>Email Id <span class="text-danger">*</span></h5>
                                            <div class="controls">                                    
                                            <f:input type="email" path="lvo.email" class="form-control" required="required" id="exampleInputEmail1"  placeholder="Enter email"/></div>
                                     <div class="form-control-feedback"></div>
                                        </div>
                                         
                                   <div class="form-group">
                                        <h5>Password <span class="text-danger">*</span></h5>
                                        <f:input type="password" path="lvo.password" class="form-control" id="pass" required="required" value=""/> 
                                        <input type="checkbox" onclick="fn()">Show Password
                                        </div>
                                      
                                      <div class="form-group row">
                                        <h5>Birth Date <span class="text-danger">*</span></h5>
                                            <f:input class="form-control" path="birthDate" type="date" required="required" id="example-date-input"/>
                                        </div>
