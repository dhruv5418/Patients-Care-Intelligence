            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Add Schedular</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Add Schedular</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Schedular</h4>
                                <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                                <f:form class="form-material form-horizontal" novalidate="" modelAttribute="data" action="insertschedular.html" method="POST">
	                                  ...
	                                  <div class="form-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="date" name="startDate"  class="form-control" required="required" data-validation-required-message="This field is required"/> </div>
	                                     ...
	                                     <div class="form-group">
	                                        ...
	                                        <div class="col-10">
	                                            <input class="form-control"  type="time" name="startTime" required="required" value="13:45:00" id="example-time-input"/>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="date" name="endDate" class="form-control" required="required" data-validation-required-message="This field is required"/> </div>
	                                        <div class="form-control-feedback"></div>
	                                    </div>
	                                    <div class="form-group">
	                                        <h5>End Time <span class="text-danger">*</span></h5>
	                                        <div class="col-10">
	                                            <input class="form-control"  type="time"  name="endTime" required="required" value="13:45:00" id="example-time-input"/>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <div class="controls">
	                                            <input type="date" name="currentDate" class="form-control" required="required" data-validation-required-message="This field is required"/> </div>
	                                        <div class="form-control-feedback"></div>
	                                    </div> 
