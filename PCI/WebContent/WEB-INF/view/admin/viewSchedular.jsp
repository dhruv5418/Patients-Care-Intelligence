            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">View Schedular</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">View Schedular</li>
                            </ol>
                ...
                <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Schedular Details</h4>
                                        ...
                                        <tbody>
                                         <c:forEach items="${list}" var="x">
                                            <tr>
                                                ...
                                                <td>${x.endTime}</td>
                                                <td>${x.currentDate}</td>
                                                <td><a href="deleteSchedular.html?id=${x.schedularId}">DELETE</a>/
													<a href="editSchedular.html?id=${x.schedularId}&id1=${x.wardVO.wardId}&id2=${x.nurseVO.nurseId}">EDIT</a>
											    </td> 
