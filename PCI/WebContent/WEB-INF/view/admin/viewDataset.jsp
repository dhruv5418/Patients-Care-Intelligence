            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">View Dataset</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">View Dataset</li>
                            </ol>
                ...
                <div class="row">
                 <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Dataset Details</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                         <c:forEach items="${list}" var="x">
                                            <tr>
                                                <td>${x.datasetName}</td>
                                                <td><img height="100" width="100" src="<%=request.getContextPath()%>/doc/${x.datasetFileName}"></td>
