...
<body class="skin-megna fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">View Nurse</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">View Nurse</li>
                            </ol>
                ...
                <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nurse Details</h4>
                                        ...
                                        <tbody>
                                         <c:forEach items="${list}" var="x">
                                            <tr>
                                                ...
                                                <td>${x.birthDate}</td>
                                            	<td>photoName</td> 
                                           		<td><a href="deleteNurse.html?id=${x.nurseId}&id1=${x.lvo.loginId}">DELETE</a>/
													<a href="editNurse.html?id=${x.nurseId}&id1=${x.lvo.loginId}">EDIT</a>
											    </td>  
                                            </tr>
                                           </c:forEach>
                                        </tbody>
    ...
    <script src="adminResources/jszip.min.js"></script>
