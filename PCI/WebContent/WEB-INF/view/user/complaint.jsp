...
<div class="wrapper"> 
  ...
  <section class="inner-intro bg-img overlay-bg-color light-color parallax parallax-background">
    <div class="container">
      <div class="row title">
        <h2 class="h2">Complaint</h2>
        <div class="page-breadcrumb"> <a href="user.html">Home</a>/<span>Complaint</span> </div>
      </div>
    </div>
  </section>
  <!-- End Intro Section --> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center">
          ...
          <p class="lead">We are ready to help you with your complaint.</p>
      ...
      <div class="row">
        <div class="col-sm-12 contact pb-60 pt-30">
         <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
          <f:form class="contact-form mt-45" id="contact" modelAttribute="data" action="insertComplaint.html">
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-field">
                  <f:input class="input-sm form-full" path="subject" id="name" type="text" name="form-name" placeholder="Complaint Subject"/>
                </div>
                <div class="form-field">
                  <f:textarea class="form-full" id="message" path="message" rows="7" name="form-message" placeholder="Your Message"/>
                </div>
