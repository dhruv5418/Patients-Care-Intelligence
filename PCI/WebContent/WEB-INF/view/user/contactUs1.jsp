  ...
  <section class="inner-intro bg-img overlay-bg-color light-color parallax parallax-background">
    <div class="container">
      <div class="row title">
        ...
        <div class="page-breadcrumb"> <a href="user.html">Home</a>/<span>Contact</span> </div>
      </div>
    </div>
  </section>
  <!-- End Intro Section --> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center">
          <h2>GET IN TOUCH</h2>
          <p class="lead">Here are a few ways to get in touch with us.</p>
      ...
      <div class="row">
        <div class="col-sm-12 contact pb-60 pt-30">
          <div class="row text-center">
            <div class="col-sm-4 pb-xs-30"> <i class="ion-android-call icon-circle pos-s"></i> <a href="#" class="mt-15 i-block">+91 9824369062</a> </div>
            ...
            <div class="col-sm-4 pb-xs-30"> <i class="ion-ios-email icon-circle pos-s"></i> <a href="dhruvj5418@.com"  class="mt-15 i-block">dhruvj5418@gmail.com</a> </div>
          </div>
        </div>
      </div>
    </div>
