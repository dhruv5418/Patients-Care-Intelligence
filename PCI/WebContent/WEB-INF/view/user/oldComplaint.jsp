...
<div class="wrapper"> 
  ...
  <section class="inner-intro bg-img overlay-bg-color light-color parallax parallax-background">
    <div class="container">
      <div class="row title">
        <h2 class="h2">Old Complaint</h2>
        <div class="page-breadcrumb"> <a href="user.html">Home</a>/<span>Old Complaint</span> </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center">
          <h2>CHECK YOUR COMPLAINTS</h2>
          <p class="lead">See solution of complaints.</p>
