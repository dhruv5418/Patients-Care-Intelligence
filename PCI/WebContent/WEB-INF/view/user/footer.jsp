...
<footer class="footer pt-80">
    <div class="container"> 
      ...
      <div class="row footer-info mb-60">
        <div class="col-md-3 col-sm-6 col-xs-12 mb-sm-30">
          ...
          <ul class="link-small">
            <li><a href="mailto:dhruvj5418@gmail.com"><i class="ion-ios-email fa-icons"></i>dhruvj5418@gmail.com</a></li>
            <li><a><i class="ion-ios-telephone fa-icons"></i>+91 9824369062</a></li>
          </ul>
        ...
        <div class="col-md-2 col-sm-6 col-xs-12 mb-sm-30">
          ...
          <ul class="link blog-link">
            ...
            <li><a href="userschedular.html"><i class="fa fa-angle-double-right"></i> My Schedule</a></li>
            <li><a href="complaint.html"><i class="fa fa-angle-double-right"></i> Complaint Us</a></li>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 mb-sm-30">
          ...
          <div class="widget-details link">
            <div class="post-type-post media">
              <div class="entry-thumbnail media-left"> <img src="userResources/images/small-img.jpg" alt="Image"> </div>
              <!-- /.entry-thumbnail -->
            ...
            <div class="post-type-post media">
              <div class="entry-thumbnail media-left"> <img src="userResources/images/small-img1.jpg" alt="Image"> </div>
              <!-- /.entry-thumbnail -->
              <div class="post-content media-body">
                <p class="entry-title"><a href="javascript:avoid(0);">Ut enim ad minim veniam, quis nostrud exercitation</a></p>
                <div class="post-meta"> On
            ...
            <div class="post-type-post media">
              <div class="entry-thumbnail media-left"> <img src="userResources/images/small-img2.jpg" alt="Image"> </div>
              <!-- /.entry-thumbnail -->
              <div class="post-content media-body">
                <p class="entry-title"><a href="javascript:avoid(0);">Ut enim ad minim veniam, quis nostrud exercitation</a></p>
                <div class="post-meta"> On
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="newsletter">
            <h5>WE ARE OPEN</h5>
            <div class="opening">
              <p> Monday - Friday : <span>8:30AM to 17:00 PM</span> </p>
              <p> Saturday - Sunday : <span>8:30AM to 15:00 PM</span> </p>
            </div>
    ...
    <div class="copyright">
      <div class="container">
        <p class=""> © 2018 <a><b>PCI</b></a>. All Rights Reserved. </p>
      </div>
    </div>
    <!-- End Copyright Bar --> 
